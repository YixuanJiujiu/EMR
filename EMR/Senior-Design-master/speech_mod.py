...
def HardClassify(text):
        ...
        keywordcategory.append("")
        #Allergy
        keywordcategory[6] = {"penicillins" , "aspirins"}
        keywordcategory.append("")
        #Family
        keywordcategory[7] = {"father" , "mother", "dad", "mom", "grandpa", "grandma", "son", "daugher", "sister", "brother", "cousin", "wife", "husband"}
        keywordcategory.append("")
        #Organ
        keywordcategory[8] = {"head","eye","eyes","nose","ear","ears","mouth","leg","legs","heart","arm","arms","lung","lungs"}
        keywordcategory.append("")
        #Be
        ...
        #Medicine
        keywordcategory[10] = {"antibiotic"}
        keywordcategory.append("")

        #Instructions
        keywordcategory[11] = {}
        keywordcategory.append("Rest","work out","quit smoking")
